...
FROM docker.io/eclipse-temurin:21.0.6_7-jre-windowsservercore-ltsc2025@sha256:f722a98bfb6d2c759d6072b7a1b9a78f8467ece3cbc0a9094a46060b7c2286c8 AS runtime
ARG branchName
ARG commitHash
ARG versionNumber
