...
![Version: 1.0.24](https://img.shields.io/badge/Version-1.0.24-informational?style=flat-square) ![AppVersion: 3.0](https://img.shields.io/badge/AppVersion-3.0-informational?style=flat-square)
...
| ingress.tls | list | `[]` |  |
| initContainer | object | `{"enabled":true,"image":{"repository":"curlimages/curl","tag":"8.12.1"}}` | set initContainer parameters |
