...
| smartDocuments.wizardAuthEnabled | bool | `true` | If set to false no user is added to the request and a `no_auth` SmartDocuments URL is used. By default wizard authentication is enabled |
