...
| opentelemetry-collector.image.tag | string | `"0.160.0@sha256:799dc6cf12c96192af37b5bdba804da8c10b3bc563b43cb90c3f3c58d9572ad6"` |  |
...
| solr.password | string | `""` | Solr basic authentication password. Required when `solr.url` is set; for the solr-operator managed Solr the credentials are generated by the operator and read from its `<solrcloud>-solrcloud-basic-auth` secret instead. |
| solr.url | string | `""` | The location of an existing solr instance (unmanaged by this chart) to be used by zac |
| solr.username | string | `""` | Solr basic authentication user name. Required when `solr.url` is set; for the solr-operator managed Solr the credentials are generated by the operator and read from its `<solrcloud>-solrcloud-basic-auth` secret instead. |
