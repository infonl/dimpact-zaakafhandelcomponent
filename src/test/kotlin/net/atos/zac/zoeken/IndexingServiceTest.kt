...
class IndexingServiceTest : BehaviorSpec({
    ...
    val converterInstances = mockk<Instance<AbstractZoekObjectConverter<ZoekObject>>>()
    val converterInstancesIterator = mockk<MutableIterator<AbstractZoekObjectConverter<ZoekObject>>>()
