...
fun createBrpConfiguration(
    ...
    verwerkingRegisterExtendedWithZaaktype: Boolean = true,
    ...
    verwerkingregister = verwerkingregisterDefault,
    verwerkingRegisterExtendedWithZaaktype = verwerkingRegisterExtendedWithZaaktype,
