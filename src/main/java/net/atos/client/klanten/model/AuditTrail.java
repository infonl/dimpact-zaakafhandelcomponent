...
public class AuditTrail {
    ...
    public String toString() {
        ...
        sb.append("    applicatieWeergave: ")
                .append(toIndentedString(applicatieWeergave))
                .append("\n");
        sb.append("    gebruikersId: ").append(toIndentedString(gebruikersId)).append("\n");
        sb.append("    gebruikersWeergave: ")
                .append(toIndentedString(gebruikersWeergave))
                .append("\n");
