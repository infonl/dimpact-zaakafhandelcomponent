...
public class Klant {
    ...
    public enum SubjectTypeEnum {
        ...
        public static final class Deserializer implements JsonbDeserializer<SubjectTypeEnum> {
            @Override
            public SubjectTypeEnum deserialize(
        ...
        public static final class Serializer implements JsonbSerializer<SubjectTypeEnum> {
            ...
            public void serialize(
                    SubjectTypeEnum obj, JsonGenerator generator, SerializationContext ctx) {
    ...
    @JsonbCreator
    public Klant(@JsonbProperty(value = "url", nillable = true) URI url) {
        this.url = url;
    }
    ...
    public String toString() {
        ...
        sb.append("    voorvoegselAchternaam: ")
                .append(toIndentedString(voorvoegselAchternaam))
                .append("\n");
