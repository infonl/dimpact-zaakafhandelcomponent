...
public class PatchedPartij  {
  ...
  */
  ...
  private List<BetrokkeneForeignKey> betrokkenen = null;

 /**
  * De Categorie relaties van een partij: Let op: Dit attribuut is EXPERIMENTEEL.
  */
  @JsonbProperty("categorieRelaties")
  private List<CategorieRelatieForeignKey> categorieRelaties = null;
  ...
  */
  ...
  private List<PartijForeignKey> vertegenwoordigden = null;

 /**
  * Rekeningnummers van een partij
  */
  @JsonbProperty("rekeningnummers")
  private List<RekeningnummerForeignKey> rekeningnummers = null;
  ...
  */
  ...
  private List<PartijIdentificatorForeignkey> partijIdentificatoren = null;
 ...
 /**
  * Taal, in ISO 639-2/B formaat, waarin de partij bij voorkeur contact heeft met de gemeente. Voorbeeld: nld. Zie: https://www.iso.org/standard/4767.html
  */
 ...
 /**
  * Adres waarop de partij door gemeente bezocht wil worden. Dit mag afwijken van voor de verstrekker eventueel in een basisregistratie bekende adressen.
  */
  @JsonbProperty("bezoekadres")
  private PartijBezoekadres bezoekadres;

 /**
  * Adres waarop de partij post van de gemeente wil ontvangen. Dit mag afwijken van voor de verstrekker eventueel in een basisregistratie bekende adressen.
  */
 ...
 @JsonbCreator
  public PatchedPartij(
    ...
    @JsonbProperty(value = "betrokkenen", nillable = true) List<BetrokkeneForeignKey> betrokkenen,
    @JsonbProperty(value = "categorieRelaties", nillable = true) List<CategorieRelatieForeignKey> categorieRelaties,
    @JsonbProperty(value = "vertegenwoordigden", nillable = true) List<PartijForeignKey> vertegenwoordigden,
    @JsonbProperty(value = "partijIdentificatoren", nillable = true) List<PartijIdentificatorForeignkey> partijIdentificatoren
  ) {
    this.uuid = uuid;
    this.url = url;
