...
/**
 * Gets or Sets CodeRegisterEnum
 */
@JsonbTypeSerializer(CodeRegisterEnum.Serializer.class)
@JsonbTypeDeserializer(CodeRegisterEnum.Deserializer.class)
public enum CodeRegisterEnum {
    ...
    public static final class Deserializer implements JsonbDeserializer<CodeRegisterEnum> {
        @Override
        public CodeRegisterEnum deserialize(JsonParser parser, DeserializationContext ctx, Type rtType) {
            return fromValue(parser.getString());
        }
    }

    public static final class Serializer implements JsonbSerializer<CodeRegisterEnum> {
        @Override
        public void serialize(CodeRegisterEnum obj, JsonGenerator generator, SerializationContext ctx) {
            generator.write(obj.value);
        }
    }

    public static CodeRegisterEnum fromValue(String text) {
        for (CodeRegisterEnum b : CodeRegisterEnum.values()) {
