...
public class PaginatedActorList {
    ...
    protected List<Actor> results = new ArrayList<>();
    ...
    public PaginatedActorList count(Integer count) {
        this.count = count;
        return this;
    }
    ...
    public PaginatedActorList next(URI next) {
        this.next = next;
        return this;
    }
    ...
    public PaginatedActorList previous(URI previous) {
        this.previous = previous;
        return this;
    }
    ...
    public PaginatedActorList results(List<Actor> results) {
        this.results = results;
        return this;
    }

    public PaginatedActorList addResultsItem(Actor resultsItem) {
    ...
    public boolean equals(Object o) {
        ...
        PaginatedActorList paginatedActorList = (PaginatedActorList) o;
        return Objects.equals(this.count, paginatedActorList.count) &&
               Objects.equals(this.next, paginatedActorList.next) &&
               Objects.equals(this.previous, paginatedActorList.previous) &&
               Objects.equals(this.results, paginatedActorList.results);
    }
    ...
    public String toString() {
        ...
        sb.append("class PaginatedActorList {\n");
