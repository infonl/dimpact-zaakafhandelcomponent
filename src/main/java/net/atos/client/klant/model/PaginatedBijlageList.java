...
public class PaginatedBijlageList {
    ...
    protected List<Bijlage> results = new ArrayList<>();
    ...
    public PaginatedBijlageList count(Integer count) {
        this.count = count;
        return this;
    }
    ...
    public PaginatedBijlageList next(URI next) {
        this.next = next;
        return this;
    }
    ...
    public PaginatedBijlageList previous(URI previous) {
        this.previous = previous;
        return this;
    }
     ...
     * @return results
     **/
    public List<Bijlage> getResults() {
        return results;
    }
     ...
     * Set results
     */
    public void setResults(List<Bijlage> results) {
        this.results = results;
    }

    public PaginatedBijlageList results(List<Bijlage> results) {
        this.results = results;
        return this;
    }

    public PaginatedBijlageList addResultsItem(Bijlage resultsItem) {
    ...
    public boolean equals(Object o) {
        ...
        PaginatedBijlageList paginatedBijlageList = (PaginatedBijlageList) o;
        return Objects.equals(this.count, paginatedBijlageList.count) &&
               Objects.equals(this.next, paginatedBijlageList.next) &&
               Objects.equals(this.previous, paginatedBijlageList.previous) &&
               Objects.equals(this.results, paginatedBijlageList.results);
    }
    ...
    public String toString() {
        ...
        sb.append("class PaginatedBijlageList {\n");
