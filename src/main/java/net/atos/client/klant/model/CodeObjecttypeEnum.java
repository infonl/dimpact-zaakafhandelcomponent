...
/**
 * Gets or Sets CodeObjecttypeEnum
 */
@JsonbTypeSerializer(CodeObjecttypeEnum.Serializer.class)
@JsonbTypeDeserializer(CodeObjecttypeEnum.Deserializer.class)
public enum CodeObjecttypeEnum {
    ...
    CodeObjecttypeEnum(String value) {
        this.value = value;
    }
    ...
    public static final class Deserializer implements JsonbDeserializer<CodeObjecttypeEnum> {
        @Override
        public CodeObjecttypeEnum deserialize(JsonParser parser, DeserializationContext ctx, Type rtType) {
            return fromValue(parser.getString());
        }
    }

    public static final class Serializer implements JsonbSerializer<CodeObjecttypeEnum> {
        @Override
        public void serialize(CodeObjecttypeEnum obj, JsonGenerator generator, SerializationContext ctx) {
            generator.write(obj.value);
        }
    }

    public static CodeObjecttypeEnum fromValue(String text) {
        for (CodeObjecttypeEnum b : CodeObjecttypeEnum.values()) {
