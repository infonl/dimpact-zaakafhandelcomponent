...
public class PersonenQueryResponseJsonbDeserializer
        implements JsonbDeserializer<PersonenQueryResponse> {

    public static final String RAADPLEEG_MET_BURGERSERVICENUMMER =
            "RaadpleegMetBurgerservicenummer";

    public static final String ZOEK_MET_GESLACHTSNAAM_EN_GEBOORTEDATUM =
            "ZoekMetGeslachtsnaamEnGeboortedatum";

    public static final String ZOEK_MET_NAAM_EN_GEMEENTE_VAN_INSCHRIJVING =
            "ZoekMetNaamEnGemeenteVanInschrijving";

    public static final String ZOEK_MET_NUMMERAANDUIDING_IDENTIFICATIE =
    ...
    public static final String ZOEK_MET_STRAAT_HUISNUMMER_EN_GEMEENTE_VAN_INSCHRIJVING =
    ...
    private static final Jsonb JSONB =
            JsonbBuilder.create(
                    new JsonbConfig()
                            ...
                            .withDeserializers(
                                    new AbstractDatumJsonbDeserializer(),
    ...
    public PersonenQueryResponse deserialize(
        ...
        return switch (type) {
            case RAADPLEEG_MET_BURGERSERVICENUMMER ->
                    JSONB.fromJson(
                            jsonObject.toString(), RaadpleegMetBurgerservicenummerResponse.class);
            ...
            case ZOEK_MET_POSTCODE_EN_HUISNUMMER ->
                    JSONB.fromJson(
                            jsonObject.toString(), ZoekMetPostcodeEnHuisnummerResponse.class);
            case ZOEK_MET_STRAAT_HUISNUMMER_EN_GEMEENTE_VAN_INSCHRIJVING ->
                    JSONB.fromJson(
                            jsonObject.toString(),
