...
public interface AdresseerbaarObjectApi {
     ...
     * Parameter huidig kan worden toegepast, zie [functionele specificatie
     ...
     * heeftAlsNevenAdres, maaktDeelUitVan (of een combinatie daarvan) of als expand&#x3D;true, dan worden de gevraagde of alle gerelateerde
     * resources als geneste resource geleverd, zie [functionele specificatie
     ...
     * <p>
     * Bevragen van de levenscyclus van een adresseerbaar object (ligplaats, standplaats of verblijfsobject) met de identificatie van een
     * adresseerbaar object. Met de geheleLvc parameter kan worden aangegeven of de gehele levenscyclus (inclusief voorkomens die uit de
     * geldige levenscyclus zijn verwijderd) of alleen de actieve levenscyclus (alleen de voorkomens die onderdeel zijn van de geldige
     * levenscyclus) gewenst zijn.
     */
    @GET
     ...
     * <p>
     * Zoek actuele adresseerbare objecten (verblijfsobjecten, standplaatsen of ligplaatsen): 1. met een nummeraanduiding identificatie. 2.
     * binnen een geometrische contour (rechthoek) in combinatie met status geconstateerd, oppervlakte, gebruiksdoel en/of type. 3. met een
     * lijst van pandidentificaties. Parameter huidig kan worden toegepast, zie [functionele specificatie
     * huidig](https://github.com/lvbag/BAG-API/blob/master/Features/huidig.feature). De geldigOp en beschikbaarOp parameters kunnen
     * gebruikt worden voor tijdreis vragen, zie [functionele specificatie
     * tijdreizen](https://github.com/lvbag/BAG-API/blob/master/Features/tijdreizen.feature). Als expand&#x3D;heeftAlsHoofdAdres,
     * heeftAlsNevenAdres, maaktDeelUitVan (of een combinatie daarvan) of als expand&#x3D;true, dan worden de gevraagde of alle gerelateerde
