 ...
 * Dit is de [BAG API](<a href="https://zakelijk.kadaster.nl/-/bag-api">...</a>) Individuele Bevragingen van de Landelijke Voorziening
 * Basisregistratie
 ...
 * specificatie volgt de [Nederlandse API-Strategie](<a href="https://docs.geostandaarden.nl/api/API-Strategie">...</a>) specificatie versie
 * van 20200204 en
...
public interface AdresApi {
     ...
     * expand](<a href="https://github.com/lvbag/BAG-API/blob/master/Features/expand.feature">...</a>). Als inclusiefEindStatus&#x3D;true,
     * dan worden ook
