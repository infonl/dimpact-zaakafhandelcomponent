...
/**
 * * &#x60;blijvend_bewaren&#x60; - Blijvend bewaren * &#x60;vernietigen&#x60; - Vernietigen
 */
@JsonbTypeSerializer(ArchiefnominatieEnum.Serializer.class)
@JsonbTypeDeserializer(ArchiefnominatieEnum.Deserializer.class)
public enum ArchiefnominatieEnum {
  ...
  ArchiefnominatieEnum(String value) {
    this.value = value;
  }
  ...
  public static final class Deserializer implements JsonbDeserializer<ArchiefnominatieEnum> {
    @Override
    public ArchiefnominatieEnum deserialize(JsonParser parser, DeserializationContext ctx, Type rtType) {
  ...
  public static final class Serializer implements JsonbSerializer<ArchiefnominatieEnum> {
    @Override
    public void serialize(ArchiefnominatieEnum obj, JsonGenerator generator, SerializationContext ctx) {
      generator.write(obj.value);
    }
  }

  public static ArchiefnominatieEnum fromValue(String text) {
    for (ArchiefnominatieEnum b : ArchiefnominatieEnum.values()) {
