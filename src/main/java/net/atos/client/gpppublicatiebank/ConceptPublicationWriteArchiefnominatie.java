...
/**
  * Geeft aan of de gegevens bij het archiveren bewaard blijven of definitief vernietigd worden. **Opmerking** handmatig opgegeven waarden worden bij het aanmaken (of wanneer de informatiecategorieën bijgewerkt worden) overschreven met de automatisch afgeleide waarden uit de gekoppelde informatiecategorie(ën).  * `blijvend_bewaren` - Blijvend bewaren * `vernietigen` - Vernietigen
  */

public class ConceptPublicationWriteArchiefnominatie  {
  ...
  public String toString() {
    ...
    sb.append("class ConceptPublicationWriteArchiefnominatie {\n");
