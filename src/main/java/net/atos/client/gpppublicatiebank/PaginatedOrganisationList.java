...
public class PaginatedOrganisationList  {
  ...
  protected List<@Valid Organisation> results = new ArrayList<>();
  ...
  public PaginatedOrganisationList count(Integer count) {
    this.count = count;
    return this;
  }
  ...
  public PaginatedOrganisationList next(URI next) {
    this.next = next;
    return this;
  }
  ...
  public PaginatedOrganisationList previous(URI previous) {
    this.previous = previous;
    return this;
  }
   ...
   **/
  @NotNull
  public List<@Valid Organisation> getResults() {
    return results;
  }
   ...
   * Set results
   */
  public void setResults(List<@Valid Organisation> results) {
    this.results = results;
  }

  public PaginatedOrganisationList results(List<@Valid Organisation> results) {
    this.results = results;
    return this;
  }

  public PaginatedOrganisationList addResultsItem(Organisation resultsItem) {
  ...
  public boolean equals(Object o) {
    ...
    PaginatedOrganisationList paginatedOrganisationList = (PaginatedOrganisationList) o;
    return Objects.equals(this.count, paginatedOrganisationList.count) &&
        Objects.equals(this.next, paginatedOrganisationList.next) &&
        Objects.equals(this.previous, paginatedOrganisationList.previous) &&
        Objects.equals(this.results, paginatedOrganisationList.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaginatedOrganisationList {\n");
