...
/**
 * * &#x60;gemeentelijst&#x60; - Register gemeenten compleet * &#x60;solijst&#x60; - Register samenwerkingsorganisaties compleet * &#x60;oorglijst&#x60; - Register overige overheidsorganisaties compleet * &#x60;zelf_toegevoegd&#x60; - Zelf-toegevoegd item
 */
@JsonbTypeSerializer(OrganisationOorsprongEnum.Serializer.class)
@JsonbTypeDeserializer(OrganisationOorsprongEnum.Deserializer.class)
public enum OrganisationOorsprongEnum {
  ...
  OrganisationOorsprongEnum(String value) {
    this.value = value;
  }
  ...
  public static final class Deserializer implements JsonbDeserializer<OrganisationOorsprongEnum> {
    @Override
    public OrganisationOorsprongEnum deserialize(JsonParser parser, DeserializationContext ctx, Type rtType) {
  ...
  public static final class Serializer implements JsonbSerializer<OrganisationOorsprongEnum> {
    @Override
    public void serialize(OrganisationOorsprongEnum obj, JsonGenerator generator, SerializationContext ctx) {
      generator.write(obj.value);
    }
  }

  public static OrganisationOorsprongEnum fromValue(String text) {
    for (OrganisationOorsprongEnum b : OrganisationOorsprongEnum.values()) {
