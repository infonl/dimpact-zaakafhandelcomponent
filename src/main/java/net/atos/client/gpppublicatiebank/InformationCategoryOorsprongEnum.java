...
/**
 * * &#x60;waardelijst&#x60; - Waardelijst * &#x60;zelf_toegevoegd&#x60; - Zelf-toegevoegd item
 */
@JsonbTypeSerializer(InformationCategoryOorsprongEnum.Serializer.class)
@JsonbTypeDeserializer(InformationCategoryOorsprongEnum.Deserializer.class)
public enum InformationCategoryOorsprongEnum {
  ...
  InformationCategoryOorsprongEnum(String value) {
    this.value = value;
  }
  ...
  public static final class Deserializer implements JsonbDeserializer<InformationCategoryOorsprongEnum> {
    @Override
    public InformationCategoryOorsprongEnum deserialize(JsonParser parser, DeserializationContext ctx, Type rtType) {
  ...
  public static final class Serializer implements JsonbSerializer<InformationCategoryOorsprongEnum> {
    @Override
    public void serialize(InformationCategoryOorsprongEnum obj, JsonGenerator generator, SerializationContext ctx) {
      generator.write(obj.value);
    }
  }

  public static InformationCategoryOorsprongEnum fromValue(String text) {
    for (InformationCategoryOorsprongEnum b : InformationCategoryOorsprongEnum.values()) {
