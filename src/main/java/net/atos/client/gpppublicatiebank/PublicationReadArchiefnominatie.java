...
/**
  * Geeft aan of de gegevens bij het archiveren bewaard blijven of definitief vernietigd worden.  * `blijvend_bewaren` - Blijvend bewaren * `vernietigen` - Vernietigen
  */

public class PublicationReadArchiefnominatie  {
  ...
  public String toString() {
    ...
    sb.append("class PublicationReadArchiefnominatie {\n");
