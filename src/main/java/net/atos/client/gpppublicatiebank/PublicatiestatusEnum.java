...
public enum PublicatiestatusEnum {
  ...
  PublicatiestatusEnum(String value) {
    this.value = value;
  }
  ...
  public static final class Deserializer implements JsonbDeserializer<PublicatiestatusEnum> {
    @Override
    public PublicatiestatusEnum deserialize(JsonParser parser, DeserializationContext ctx, Type rtType) {
  ...
  public static final class Serializer implements JsonbSerializer<PublicatiestatusEnum> {
    @Override
    public void serialize(PublicatiestatusEnum obj, JsonGenerator generator, SerializationContext ctx) {
      generator.write(obj.value);
    }
  }

  public static PublicatiestatusEnum fromValue(String text) {
    for (PublicatiestatusEnum b : PublicatiestatusEnum.values()) {
