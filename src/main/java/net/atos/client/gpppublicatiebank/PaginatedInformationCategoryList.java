...
public class PaginatedInformationCategoryList  {
  ...
  protected List<@Valid InformationCategory> results = new ArrayList<>();
  ...
  public PaginatedInformationCategoryList count(Integer count) {
    this.count = count;
    return this;
  }
  ...
  public PaginatedInformationCategoryList next(URI next) {
    this.next = next;
    return this;
  }
  ...
  public PaginatedInformationCategoryList previous(URI previous) {
    this.previous = previous;
    return this;
  }
   ...
   **/
  @NotNull
  public List<@Valid InformationCategory> getResults() {
    return results;
  }
   ...
   * Set results
   */
  public void setResults(List<@Valid InformationCategory> results) {
    this.results = results;
  }

  public PaginatedInformationCategoryList results(List<@Valid InformationCategory> results) {
    this.results = results;
    return this;
  }

  public PaginatedInformationCategoryList addResultsItem(InformationCategory resultsItem) {
  ...
  public boolean equals(Object o) {
    ...
    PaginatedInformationCategoryList paginatedInformationCategoryList = (PaginatedInformationCategoryList) o;
    return Objects.equals(this.count, paginatedInformationCategoryList.count) &&
        Objects.equals(this.next, paginatedInformationCategoryList.next) &&
        Objects.equals(this.previous, paginatedInformationCategoryList.previous) &&
        Objects.equals(this.results, paginatedInformationCategoryList.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaginatedInformationCategoryList {\n");
