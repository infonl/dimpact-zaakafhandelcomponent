...
/**
  * Base serializer for publication read and write operations.  This base class defines the shared logic that should be kept in sync between read and write operations for consistent API documentation (and behaviour).
  */

public class PublishedOrRevokedPublicationWrite  {
  ...
  */
  ...
  public PublishedOrRevokedPublicationWrite() {
  }
 ...
 @JsonbCreator
  ...
  public PublishedOrRevokedPublicationWrite urlPublicatieIntern(WerkEenPublicatieInZijnGeheelBij urlPublicatieIntern) {
    this.urlPublicatieIntern = urlPublicatieIntern;
    return this;
  }
  ...
  public PublishedOrRevokedPublicationWrite urlPublicatieExtern(ExternePublicatieURL urlPublicatieExtern) {
    this.urlPublicatieExtern = urlPublicatieExtern;
    return this;
  }
  ...
  public PublishedOrRevokedPublicationWrite informatieCategorieen(List<UUID> informatieCategorieen) {
    this.informatieCategorieen = informatieCategorieen;
    return this;
  }

  public PublishedOrRevokedPublicationWrite addInformatieCategorieenItem(UUID informatieCategorieenItem) {
  ...
  public PublishedOrRevokedPublicationWrite onderwerpen(List<UUID> onderwerpen) {
    this.onderwerpen = onderwerpen;
    return this;
  }

  public PublishedOrRevokedPublicationWrite addOnderwerpenItem(UUID onderwerpenItem) {
  ...
  public PublishedOrRevokedPublicationWrite publisher(UUID publisher) {
    this.publisher = publisher;
    return this;
  }
  ...
  public PublishedOrRevokedPublicationWrite verantwoordelijke(UUID verantwoordelijke) {
    this.verantwoordelijke = verantwoordelijke;
    return this;
  }
  ...
  public PublishedOrRevokedPublicationWrite opsteller(UUID opsteller) {
    this.opsteller = opsteller;
    return this;
  }
  ...
  public PublishedOrRevokedPublicationWrite kenmerken(List<@Valid PublicationIdentifier> kenmerken) {
    this.kenmerken = kenmerken;
    return this;
  }

  public PublishedOrRevokedPublicationWrite addKenmerkenItem(PublicationIdentifier kenmerkenItem) {
  ...
  public PublishedOrRevokedPublicationWrite officieleTitel(String officieleTitel) {
    this.officieleTitel = officieleTitel;
    return this;
  }
  ...
  public PublishedOrRevokedPublicationWrite verkorteTitel(String verkorteTitel) {
    this.verkorteTitel = verkorteTitel;
    return this;
  }
  ...
  public PublishedOrRevokedPublicationWrite omschrijving(String omschrijving) {
    this.omschrijving = omschrijving;
    return this;
  }
  ...
  public PublishedOrRevokedPublicationWrite eigenaar(Eigenaar eigenaar) {
    this.eigenaar = eigenaar;
    return this;
  }
  ...
  public PublishedOrRevokedPublicationWrite publicatiestatus(PublicatiestatusEnum publicatiestatus) {
    this.publicatiestatus = publicatiestatus;
    return this;
  }
  ...
  public PublishedOrRevokedPublicationWrite datumBeginGeldigheid(LocalDate datumBeginGeldigheid) {
    this.datumBeginGeldigheid = datumBeginGeldigheid;
    return this;
  }
  ...
  public PublishedOrRevokedPublicationWrite datumEindeGeldigheid(LocalDate datumEindeGeldigheid) {
    this.datumEindeGeldigheid = datumEindeGeldigheid;
    return this;
  }
  ...
  public PublishedOrRevokedPublicationWrite bronBewaartermijn(String bronBewaartermijn) {
    this.bronBewaartermijn = bronBewaartermijn;
    return this;
  }
  ...
  public PublishedOrRevokedPublicationWrite selectiecategorie(String selectiecategorie) {
    this.selectiecategorie = selectiecategorie;
    return this;
  }
  ...
  public PublishedOrRevokedPublicationWrite archiefnominatie(ConceptPublicationWriteArchiefnominatie archiefnominatie) {
    this.archiefnominatie = archiefnominatie;
    return this;
  }
  ...
  public PublishedOrRevokedPublicationWrite archiefactiedatum(LocalDate archiefactiedatum) {
    this.archiefactiedatum = archiefactiedatum;
    return this;
  }
  ...
  public PublishedOrRevokedPublicationWrite toelichtingBewaartermijn(String toelichtingBewaartermijn) {
    this.toelichtingBewaartermijn = toelichtingBewaartermijn;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PublishedOrRevokedPublicationWrite publishedOrRevokedPublicationWrite = (PublishedOrRevokedPublicationWrite) o;
    return Objects.equals(this.uuid, publishedOrRevokedPublicationWrite.uuid) &&
        Objects.equals(this.urlPublicatieIntern, publishedOrRevokedPublicationWrite.urlPublicatieIntern) &&
        Objects.equals(this.urlPublicatieExtern, publishedOrRevokedPublicationWrite.urlPublicatieExtern) &&
        Objects.equals(this.informatieCategorieen, publishedOrRevokedPublicationWrite.informatieCategorieen) &&
        Objects.equals(this.diWooInformatieCategorieen, publishedOrRevokedPublicationWrite.diWooInformatieCategorieen) &&
        Objects.equals(this.onderwerpen, publishedOrRevokedPublicationWrite.onderwerpen) &&
        Objects.equals(this.publisher, publishedOrRevokedPublicationWrite.publisher) &&
        Objects.equals(this.verantwoordelijke, publishedOrRevokedPublicationWrite.verantwoordelijke) &&
        Objects.equals(this.opsteller, publishedOrRevokedPublicationWrite.opsteller) &&
        Objects.equals(this.kenmerken, publishedOrRevokedPublicationWrite.kenmerken) &&
        Objects.equals(this.officieleTitel, publishedOrRevokedPublicationWrite.officieleTitel) &&
        Objects.equals(this.verkorteTitel, publishedOrRevokedPublicationWrite.verkorteTitel) &&
        Objects.equals(this.omschrijving, publishedOrRevokedPublicationWrite.omschrijving) &&
        Objects.equals(this.eigenaar, publishedOrRevokedPublicationWrite.eigenaar) &&
        Objects.equals(this.publicatiestatus, publishedOrRevokedPublicationWrite.publicatiestatus) &&
        Objects.equals(this.gepubliceerdOp, publishedOrRevokedPublicationWrite.gepubliceerdOp) &&
        Objects.equals(this.ingetrokkenOp, publishedOrRevokedPublicationWrite.ingetrokkenOp) &&
        Objects.equals(this.registratiedatum, publishedOrRevokedPublicationWrite.registratiedatum) &&
        Objects.equals(this.laatstGewijzigdDatum, publishedOrRevokedPublicationWrite.laatstGewijzigdDatum) &&
        Objects.equals(this.datumBeginGeldigheid, publishedOrRevokedPublicationWrite.datumBeginGeldigheid) &&
        Objects.equals(this.datumEindeGeldigheid, publishedOrRevokedPublicationWrite.datumEindeGeldigheid) &&
        Objects.equals(this.bronBewaartermijn, publishedOrRevokedPublicationWrite.bronBewaartermijn) &&
        Objects.equals(this.selectiecategorie, publishedOrRevokedPublicationWrite.selectiecategorie) &&
        Objects.equals(this.archiefnominatie, publishedOrRevokedPublicationWrite.archiefnominatie) &&
        Objects.equals(this.archiefactiedatum, publishedOrRevokedPublicationWrite.archiefactiedatum) &&
        Objects.equals(this.toelichtingBewaartermijn, publishedOrRevokedPublicationWrite.toelichtingBewaartermijn);
  }
  ...
  public String toString() {
    ...
    sb.append("class PublishedOrRevokedPublicationWrite {\n");
