...
public class PatchedDocumentUpdate  {
  ...
  */
  ...
  public PatchedDocumentUpdate() {
  }

 @JsonbCreator
  public PatchedDocumentUpdate(
    @JsonbProperty(value = "uuid", nillable = true) UUID uuid, 
    @JsonbProperty(value = "identifier", nillable = true) String identifier, 
    @JsonbProperty(value = "publicatie", nillable = true) UUID publicatie, 
    @JsonbProperty(value = "gepubliceerdOp", nillable = true) OffsetDateTime gepubliceerdOp, 
    @JsonbProperty(value = "ingetrokkenOp", nillable = true) OffsetDateTime ingetrokkenOp, 
    @JsonbProperty(value = "bestandsformaat", nillable = true) String bestandsformaat, 
    @JsonbProperty(value = "bestandsnaam", nillable = true) String bestandsnaam, 
    @JsonbProperty(value = "bestandsomvang", nillable = true) Integer bestandsomvang, 
    @JsonbProperty(value = "registratiedatum", nillable = true) OffsetDateTime registratiedatum, 
    @JsonbProperty(value = "laatstGewijzigdDatum", nillable = true) OffsetDateTime laatstGewijzigdDatum, 
    @JsonbProperty(value = "uploadVoltooid", nillable = true) Boolean uploadVoltooid
  ) {
    this.uuid = uuid;
  ...
  public PatchedDocumentUpdate kenmerken(List<@Valid DocumentIdentifier> kenmerken) {
    this.kenmerken = kenmerken;
    return this;
  }

  public PatchedDocumentUpdate addKenmerkenItem(DocumentIdentifier kenmerkenItem) {
  ...
  public PatchedDocumentUpdate officieleTitel(String officieleTitel) {
    this.officieleTitel = officieleTitel;
    return this;
  }
  ...
  public PatchedDocumentUpdate verkorteTitel(String verkorteTitel) {
    this.verkorteTitel = verkorteTitel;
    return this;
  }
  ...
  public PatchedDocumentUpdate omschrijving(String omschrijving) {
    this.omschrijving = omschrijving;
    return this;
  }
  ...
  public PatchedDocumentUpdate publicatiestatus(PublicatiestatusEnum publicatiestatus) {
    this.publicatiestatus = publicatiestatus;
    return this;
  }
  ...
  public PatchedDocumentUpdate creatiedatum(LocalDate creatiedatum) {
    this.creatiedatum = creatiedatum;
    return this;
  }
  ...
  public PatchedDocumentUpdate ontvangstdatum(OffsetDateTime ontvangstdatum) {
    this.ontvangstdatum = ontvangstdatum;
    return this;
  }
  ...
  public PatchedDocumentUpdate datumOndertekend(OffsetDateTime datumOndertekend) {
    this.datumOndertekend = datumOndertekend;
    return this;
  }
  ...
  public PatchedDocumentUpdate eigenaar(Eigenaar eigenaar) {
    this.eigenaar = eigenaar;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PatchedDocumentUpdate patchedDocumentUpdate = (PatchedDocumentUpdate) o;
    return Objects.equals(this.uuid, patchedDocumentUpdate.uuid) &&
        Objects.equals(this.identifier, patchedDocumentUpdate.identifier) &&
        Objects.equals(this.publicatie, patchedDocumentUpdate.publicatie) &&
        Objects.equals(this.kenmerken, patchedDocumentUpdate.kenmerken) &&
        Objects.equals(this.officieleTitel, patchedDocumentUpdate.officieleTitel) &&
        Objects.equals(this.verkorteTitel, patchedDocumentUpdate.verkorteTitel) &&
        Objects.equals(this.omschrijving, patchedDocumentUpdate.omschrijving) &&
        Objects.equals(this.publicatiestatus, patchedDocumentUpdate.publicatiestatus) &&
        Objects.equals(this.gepubliceerdOp, patchedDocumentUpdate.gepubliceerdOp) &&
        Objects.equals(this.ingetrokkenOp, patchedDocumentUpdate.ingetrokkenOp) &&
        Objects.equals(this.creatiedatum, patchedDocumentUpdate.creatiedatum) &&
        Objects.equals(this.ontvangstdatum, patchedDocumentUpdate.ontvangstdatum) &&
        Objects.equals(this.datumOndertekend, patchedDocumentUpdate.datumOndertekend) &&
        Objects.equals(this.bestandsformaat, patchedDocumentUpdate.bestandsformaat) &&
        Objects.equals(this.bestandsnaam, patchedDocumentUpdate.bestandsnaam) &&
        Objects.equals(this.bestandsomvang, patchedDocumentUpdate.bestandsomvang) &&
        Objects.equals(this.eigenaar, patchedDocumentUpdate.eigenaar) &&
        Objects.equals(this.registratiedatum, patchedDocumentUpdate.registratiedatum) &&
        Objects.equals(this.laatstGewijzigdDatum, patchedDocumentUpdate.laatstGewijzigdDatum) &&
        Objects.equals(this.uploadVoltooid, patchedDocumentUpdate.uploadVoltooid);
  }
  ...
  public String toString() {
    ...
    sb.append("class PatchedDocumentUpdate {\n");
