...
public class DocumentCreateRetrieveUrlDocumentCreate  {
 ...
 /**
  * Als de aanleverwijze op `ophalen` staat, dan wordt dit verwerkt op de achtergrond en worden er geen `bestandsdelen` teruggegeven in het antwoord. Voor directe uploads wordt er een lijst van verwachte `bestandsdelen` teruggegeven.  * `ontvangen` - Ontvangen * `ophalen` - Ophalen
  */
  @JsonbProperty("aanleveringBestand")
  protected AanleveringBestandEnum aanleveringBestand = AanleveringBestandEnum.ONTVANGEN;

 /**
  * De verwachte bestandsdelen/chunks om de bestandsinhoud te uploaden. Deze zijn afgeleid uit de opgegeven totale bestandsgrootte (`bestandsomvang`) in de body van de document-create-operatie.
  */
  @JsonbProperty("bestandsdelen")
  protected List<@Valid FilePart> bestandsdelen;
  ...
  */
  ...
  public DocumentCreateRetrieveUrlDocumentCreate() {
  }
 ...
 @JsonbCreator
  public DocumentCreateRetrieveUrlDocumentCreate(
    ...
    @JsonbProperty(value = "bestandsdelen") List<@Valid FilePart> bestandsdelen
  ) {
    this.uuid = uuid;
  ...
  public DocumentCreateRetrieveUrlDocumentCreate identifier(String identifier) {
    this.identifier = identifier;
    return this;
  }
  ...
  public DocumentCreateRetrieveUrlDocumentCreate publicatie(UUID publicatie) {
    this.publicatie = publicatie;
    return this;
  }
  ...
  public DocumentCreateRetrieveUrlDocumentCreate kenmerken(List<@Valid DocumentIdentifier> kenmerken) {
    this.kenmerken = kenmerken;
    return this;
  }

  public DocumentCreateRetrieveUrlDocumentCreate addKenmerkenItem(DocumentIdentifier kenmerkenItem) {
  ...
  public DocumentCreateRetrieveUrlDocumentCreate officieleTitel(String officieleTitel) {
    this.officieleTitel = officieleTitel;
    return this;
  }
  ...
  public DocumentCreateRetrieveUrlDocumentCreate verkorteTitel(String verkorteTitel) {
    this.verkorteTitel = verkorteTitel;
    return this;
  }
  ...
  public DocumentCreateRetrieveUrlDocumentCreate omschrijving(String omschrijving) {
    this.omschrijving = omschrijving;
    return this;
  }
  ...
  public DocumentCreateRetrieveUrlDocumentCreate creatiedatum(LocalDate creatiedatum) {
    this.creatiedatum = creatiedatum;
    return this;
  }
  ...
  public DocumentCreateRetrieveUrlDocumentCreate ontvangstdatum(OffsetDateTime ontvangstdatum) {
    this.ontvangstdatum = ontvangstdatum;
    return this;
  }
  ...
  public DocumentCreateRetrieveUrlDocumentCreate datumOndertekend(OffsetDateTime datumOndertekend) {
    this.datumOndertekend = datumOndertekend;
    return this;
  }
  ...
  public DocumentCreateRetrieveUrlDocumentCreate bestandsformaat(String bestandsformaat) {
    this.bestandsformaat = bestandsformaat;
    return this;
  }
  ...
  public DocumentCreateRetrieveUrlDocumentCreate bestandsnaam(String bestandsnaam) {
    this.bestandsnaam = bestandsnaam;
    return this;
  }
 ...
 @Min(0L) @Max(9223372036854775807L)  public Long getBestandsomvang() {
  ...
  public DocumentCreateRetrieveUrlDocumentCreate bestandsomvang(Long bestandsomvang) {
    this.bestandsomvang = bestandsomvang;
    return this;
  }
  ...
  public DocumentCreateRetrieveUrlDocumentCreate eigenaar(Eigenaar eigenaar) {
    this.eigenaar = eigenaar;
    return this;
  }
  ...
  /**
   * Als de aanleverwijze op &#x60;ophalen&#x60; staat, dan wordt dit verwerkt op de achtergrond en worden er geen &#x60;bestandsdelen&#x60; teruggegeven in het antwoord. Voor directe uploads wordt er een lijst van verwachte &#x60;bestandsdelen&#x60; teruggegeven.  * &#x60;ontvangen&#x60; - Ontvangen * &#x60;ophalen&#x60; - Ophalen
   * @return aanleveringBestand
   **/
  public AanleveringBestandEnum getAanleveringBestand() {
    return aanleveringBestand;
  }

  /**
   * Set aanleveringBestand
   */
  public void setAanleveringBestand(AanleveringBestandEnum aanleveringBestand) {
    this.aanleveringBestand = aanleveringBestand;
  }

  public DocumentCreateRetrieveUrlDocumentCreate aanleveringBestand(AanleveringBestandEnum aanleveringBestand) {
    this.aanleveringBestand = aanleveringBestand;
    return this;
  }
   ...
   **/
  public List<@Valid FilePart> getBestandsdelen() {
    return bestandsdelen;
  }
  ...
  public DocumentCreateRetrieveUrlDocumentCreate documentUrl(URI documentUrl) {
    this.documentUrl = documentUrl;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DocumentCreateRetrieveUrlDocumentCreate documentCreateRetrieveUrlDocumentCreate = (DocumentCreateRetrieveUrlDocumentCreate) o;
    return Objects.equals(this.uuid, documentCreateRetrieveUrlDocumentCreate.uuid) &&
        Objects.equals(this.identifier, documentCreateRetrieveUrlDocumentCreate.identifier) &&
        Objects.equals(this.publicatie, documentCreateRetrieveUrlDocumentCreate.publicatie) &&
        Objects.equals(this.kenmerken, documentCreateRetrieveUrlDocumentCreate.kenmerken) &&
        Objects.equals(this.officieleTitel, documentCreateRetrieveUrlDocumentCreate.officieleTitel) &&
        Objects.equals(this.verkorteTitel, documentCreateRetrieveUrlDocumentCreate.verkorteTitel) &&
        Objects.equals(this.omschrijving, documentCreateRetrieveUrlDocumentCreate.omschrijving) &&
        Objects.equals(this.publicatiestatus, documentCreateRetrieveUrlDocumentCreate.publicatiestatus) &&
        Objects.equals(this.gepubliceerdOp, documentCreateRetrieveUrlDocumentCreate.gepubliceerdOp) &&
        Objects.equals(this.ingetrokkenOp, documentCreateRetrieveUrlDocumentCreate.ingetrokkenOp) &&
        Objects.equals(this.creatiedatum, documentCreateRetrieveUrlDocumentCreate.creatiedatum) &&
        Objects.equals(this.ontvangstdatum, documentCreateRetrieveUrlDocumentCreate.ontvangstdatum) &&
        Objects.equals(this.datumOndertekend, documentCreateRetrieveUrlDocumentCreate.datumOndertekend) &&
        Objects.equals(this.bestandsformaat, documentCreateRetrieveUrlDocumentCreate.bestandsformaat) &&
        Objects.equals(this.bestandsnaam, documentCreateRetrieveUrlDocumentCreate.bestandsnaam) &&
        Objects.equals(this.bestandsomvang, documentCreateRetrieveUrlDocumentCreate.bestandsomvang) &&
        Objects.equals(this.eigenaar, documentCreateRetrieveUrlDocumentCreate.eigenaar) &&
        Objects.equals(this.registratiedatum, documentCreateRetrieveUrlDocumentCreate.registratiedatum) &&
        Objects.equals(this.laatstGewijzigdDatum, documentCreateRetrieveUrlDocumentCreate.laatstGewijzigdDatum) &&
        Objects.equals(this.uploadVoltooid, documentCreateRetrieveUrlDocumentCreate.uploadVoltooid) &&
        Objects.equals(this.aanleveringBestand, documentCreateRetrieveUrlDocumentCreate.aanleveringBestand) &&
        Objects.equals(this.bestandsdelen, documentCreateRetrieveUrlDocumentCreate.bestandsdelen) &&
        Objects.equals(this.documentUrl, documentCreateRetrieveUrlDocumentCreate.documentUrl);
  }

  @Override
  public int hashCode() {
    return Objects.hash(uuid, identifier, publicatie, kenmerken, officieleTitel, verkorteTitel, omschrijving, publicatiestatus, gepubliceerdOp, ingetrokkenOp, creatiedatum, ontvangstdatum, datumOndertekend, bestandsformaat, bestandsnaam, bestandsomvang, eigenaar, registratiedatum, laatstGewijzigdDatum, uploadVoltooid, aanleveringBestand, bestandsdelen, documentUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("class DocumentCreateRetrieveUrlDocumentCreate {\n");
    ...
    sb.append("    aanleveringBestand: ").append(toIndentedString(aanleveringBestand)).append("\n");
    sb.append("    bestandsdelen: ").append(toIndentedString(bestandsdelen)).append("\n");
