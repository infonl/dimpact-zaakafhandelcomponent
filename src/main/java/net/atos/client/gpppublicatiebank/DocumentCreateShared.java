...
public class DocumentCreateShared  {
 ...
 @JsonbCreator
  ...
  public DocumentCreateShared identifier(String identifier) {
    this.identifier = identifier;
    return this;
  }
  ...
  public DocumentCreateShared publicatie(UUID publicatie) {
    this.publicatie = publicatie;
    return this;
  }
  ...
  public DocumentCreateShared kenmerken(List<@Valid DocumentIdentifier> kenmerken) {
    this.kenmerken = kenmerken;
    return this;
  }

  public DocumentCreateShared addKenmerkenItem(DocumentIdentifier kenmerkenItem) {
  ...
  public DocumentCreateShared officieleTitel(String officieleTitel) {
    this.officieleTitel = officieleTitel;
    return this;
  }
  ...
  public DocumentCreateShared verkorteTitel(String verkorteTitel) {
    this.verkorteTitel = verkorteTitel;
    return this;
  }
  ...
  public DocumentCreateShared omschrijving(String omschrijving) {
    this.omschrijving = omschrijving;
    return this;
  }
  ...
  public DocumentCreateShared creatiedatum(LocalDate creatiedatum) {
    this.creatiedatum = creatiedatum;
    return this;
  }
  ...
  public DocumentCreateShared ontvangstdatum(OffsetDateTime ontvangstdatum) {
    this.ontvangstdatum = ontvangstdatum;
    return this;
  }
  ...
  public DocumentCreateShared datumOndertekend(OffsetDateTime datumOndertekend) {
    this.datumOndertekend = datumOndertekend;
    return this;
  }
  ...
  public DocumentCreateShared bestandsformaat(String bestandsformaat) {
    this.bestandsformaat = bestandsformaat;
    return this;
  }
  ...
  public DocumentCreateShared bestandsnaam(String bestandsnaam) {
    this.bestandsnaam = bestandsnaam;
    return this;
  }
 ...
 @Min(0L) @Max(9223372036854775807L)  public Long getBestandsomvang() {
  ...
  public DocumentCreateShared bestandsomvang(Long bestandsomvang) {
    this.bestandsomvang = bestandsomvang;
    return this;
  }
  ...
  public DocumentCreateShared eigenaar(Eigenaar eigenaar) {
    this.eigenaar = eigenaar;
    return this;
  }
  ...
  public DocumentCreateShared aanleveringBestand(AanleveringBestandEnum aanleveringBestand) {
    this.aanleveringBestand = aanleveringBestand;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DocumentCreateShared documentCreateShared = (DocumentCreateShared) o;
    return Objects.equals(this.uuid, documentCreateShared.uuid) &&
        Objects.equals(this.identifier, documentCreateShared.identifier) &&
        Objects.equals(this.publicatie, documentCreateShared.publicatie) &&
        Objects.equals(this.kenmerken, documentCreateShared.kenmerken) &&
        Objects.equals(this.officieleTitel, documentCreateShared.officieleTitel) &&
        Objects.equals(this.verkorteTitel, documentCreateShared.verkorteTitel) &&
        Objects.equals(this.omschrijving, documentCreateShared.omschrijving) &&
        Objects.equals(this.publicatiestatus, documentCreateShared.publicatiestatus) &&
        Objects.equals(this.gepubliceerdOp, documentCreateShared.gepubliceerdOp) &&
        Objects.equals(this.ingetrokkenOp, documentCreateShared.ingetrokkenOp) &&
        Objects.equals(this.creatiedatum, documentCreateShared.creatiedatum) &&
        Objects.equals(this.ontvangstdatum, documentCreateShared.ontvangstdatum) &&
        Objects.equals(this.datumOndertekend, documentCreateShared.datumOndertekend) &&
        Objects.equals(this.bestandsformaat, documentCreateShared.bestandsformaat) &&
        Objects.equals(this.bestandsnaam, documentCreateShared.bestandsnaam) &&
        Objects.equals(this.bestandsomvang, documentCreateShared.bestandsomvang) &&
        Objects.equals(this.eigenaar, documentCreateShared.eigenaar) &&
        Objects.equals(this.registratiedatum, documentCreateShared.registratiedatum) &&
        Objects.equals(this.laatstGewijzigdDatum, documentCreateShared.laatstGewijzigdDatum) &&
        Objects.equals(this.uploadVoltooid, documentCreateShared.uploadVoltooid) &&
        Objects.equals(this.aanleveringBestand, documentCreateShared.aanleveringBestand) &&
        Objects.equals(this.bestandsdelen, documentCreateShared.bestandsdelen);
  }

  @Override
  public int hashCode() {
    return Objects.hash(uuid, identifier, publicatie, kenmerken, officieleTitel, verkorteTitel, omschrijving, publicatiestatus, gepubliceerdOp, ingetrokkenOp, creatiedatum, ontvangstdatum, datumOndertekend, bestandsformaat, bestandsnaam, bestandsomvang, eigenaar, registratiedatum, laatstGewijzigdDatum, uploadVoltooid, aanleveringBestand, bestandsdelen);
  }
  ...
  public String toString() {
    ...
    sb.append("class DocumentCreateShared {\n");
