...
/**
 * * &#x60;ontvangen&#x60; - Ontvangen * &#x60;ophalen&#x60; - Ophalen
 */
@JsonbTypeSerializer(AanleveringBestandEnum.Serializer.class)
@JsonbTypeDeserializer(AanleveringBestandEnum.Deserializer.class)
public enum AanleveringBestandEnum {
  ...
  AanleveringBestandEnum(String value) {
    this.value = value;
  }
  ...
  public static final class Deserializer implements JsonbDeserializer<AanleveringBestandEnum> {
    @Override
    public AanleveringBestandEnum deserialize(JsonParser parser, DeserializationContext ctx, Type rtType) {
  ...
  public static final class Serializer implements JsonbSerializer<AanleveringBestandEnum> {
    @Override
    public void serialize(AanleveringBestandEnum obj, JsonGenerator generator, SerializationContext ctx) {
      generator.write(obj.value);
    }
  }

  public static AanleveringBestandEnum fromValue(String text) {
    for (AanleveringBestandEnum b : AanleveringBestandEnum.values()) {
