...
/**
  * De URL die verwijst naar de UI van de interne applicatie waar de publicatie beheerd wordt. Dit vereist dat de algemene configuratieparameter ingevuld is, anders wordt er een lege string teruggestuurd.
  */

public class WerkEenPublicatieInZijnGeheelBij  {
  ...
  public String toString() {
    ...
    sb.append("class WerkEenPublicatieInZijnGeheelBij {\n");
