...
public class AuditTrail  {
  ...
  **/
  ...
  public enum BronEnum {
    ...
    AC(String.valueOf("ac")), NRC(String.valueOf("nrc")), ZRC(String.valueOf("zrc")), ZTC(String.valueOf("ztc")), DRC(String.valueOf("drc")), BRC(String.valueOf("brc")), CMC(String.valueOf("cmc")), KC(String.valueOf("kc"));
