...
public class DRCClientService {
  ...
  public ByteArrayInputStream downloadEnkelvoudigInformatieobject(
    ...
    if (!response.bufferEntity()) {
      throw new RuntimeException(
          String.format(
              "Content of enkelvoudig informatieobject with uuid '%s' could not be buffered.",
  ...
  public ByteArrayInputStream downloadEnkelvoudigInformatieobjectVersie(
    ...
    if (!response.bufferEntity()) {
      throw new RuntimeException(
          String.format(
              "Content of enkelvoudig informatieobject with uuid '%s' and version '%d' could not be"
                  + " buffered.",
