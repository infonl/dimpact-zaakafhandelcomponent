...
public class RolNatuurlijkPersoon extends Rol<NatuurlijkPersoon> {
  ...
  public RolNatuurlijkPersoon(
    ...
    super(
        zaak, roltype, BetrokkeneType.NATUURLIJK_PERSOON, betrokkeneIdentificatie, roltoelichting);
  }
  ...
  protected boolean equalBetrokkeneIdentificatie(final NatuurlijkPersoon identificatie) {
    ...
    if (betrokkeneIdentificatie.getAnpIdentificatie() != null
      ...
      return Objects.equals(
          betrokkeneIdentificatie.getAnpIdentificatie(), identificatie.getAnpIdentificatie());
    }
