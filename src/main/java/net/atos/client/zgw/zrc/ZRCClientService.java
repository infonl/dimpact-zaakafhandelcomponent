...
public class ZRCClientService {
    ...
    if (zaakInformatieobjecten.isEmpty()) {
      throw new NotFoundException(
          String.format(
              ...
              oudeZaak.getIdentificatie(), UriUtil.uuidFromURI(informatieobject.getInhoud())));
    }
  ...
  private void deleteDeletedRollen(
      final Collection<Rol<?>> current, final Collection<Rol<?>> rollen, final String toelichting) {
    current.stream()
