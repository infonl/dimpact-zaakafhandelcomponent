...
public class Zaak {
   ...
   */
  public Zaak(
      final URI zaaktype, final String bronorganisatie, final String verantwoordelijkeOrganisatie) {
    this.bronorganisatie = bronorganisatie;
    this.zaaktype = zaaktype;
    this.verantwoordelijkeOrganisatie = verantwoordelijkeOrganisatie;
  ...
  @JsonbTransient
  // Niet hernoemen naar isHoofdzaak omdat anders het 'hoofdzaak' attribuut niet meer wordt omgezet
  // naar JSON
