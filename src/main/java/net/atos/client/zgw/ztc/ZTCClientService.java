...
public class ZTCClientService implements Caching {
    ...
    return readZaaktypeInformatieobjecttypen(zaaktypeURI).stream()
        .map(
            zaaktypeInformatieobjecttype ->
                readInformatieobjecttype(zaaktypeInformatieobjecttype.getInformatieobjecttype()))
        .toList();
  }
  ...
  public Optional<RolType> findRoltype(
      final URI zaaktypeURI, final RolType.OmschrijvingGeneriekEnum omschrijvingGeneriekEnum) {
    return ztcClient
  ...
  public RolType readRoltype(
      final RolType.OmschrijvingGeneriekEnum omschrijvingGeneriekEnum, final URI zaaktypeURI) {
    return ztcClient
        .roltypeList(new RoltypeListParameters(zaaktypeURI, omschrijvingGeneriekEnum))
        .getSingleResult()
        .orElseThrow(
            () ->
                new RuntimeException(
                    format(
                        ...
                        zaaktypeURI.toString(), omschrijvingGeneriekEnum.toString())));
  }
