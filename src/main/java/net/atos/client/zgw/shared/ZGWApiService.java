...
public class ZGWApiService {
  ...
  public Resultaat createResultaatForZaak(
      final Zaak zaak, final String resultaattypeOmschrijving, final String resultaatToelichting) {
  ...
  public Optional<RolMedewerker> findBehandelaarForZaak(final Zaak zaak) {
    return findRolForZaak(
            zaak, RolType.OmschrijvingGeneriekEnum.BEHANDELAAR, BetrokkeneType.MEDEWERKER)
  ...
  private Optional<Rol<?>> findRolForZaak(
    ...
    return ztcClientService
        ...
        .flatMap(
            roltype ->
                zrcClientService
                    .listRollen(new RolListParameters(zaak.getUrl(), roltype.getUrl()))
                    .getSingleResult());
  }
        ...
        .orElseThrow(
            () ->
                new RuntimeException(
                    String.format(
                        "Zaaktype '%s': Resultaattype with omschrijving '%s' not found",
    ...
    return statustypes.stream()
        ...
        .orElseThrow(
            () ->
                new RuntimeException(
                    String.format(
                        "Zaaktype '%s': Statustype with omschrijving '%s' not found",
                        zaaktypeURI, omschrijving)));
  }
    ...
    return statustypes.stream()
        ...
        .orElseThrow(
            () ->
                new RuntimeException(
                    String.format(
                        "Zaaktype '%s': No eind Status found for Zaaktype.", zaaktypeURI)));
  }
}
