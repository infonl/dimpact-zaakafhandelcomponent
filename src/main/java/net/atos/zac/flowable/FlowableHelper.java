...
import nl.info.client.gpppublicatiebank.GppPublicatiebankClientService;
...
public class FlowableHelper {
    ...
    @Inject
    private GppPublicatiebankClientService gppPublicatiebankClientService;
    ...
    public GppPublicatiebankClientService getGppPublicatiebankClientService() {
        return gppPublicatiebankClientService;
    }
}
