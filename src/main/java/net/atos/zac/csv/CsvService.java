...
public class CsvService {
    ...
    private static final char QUOTE_ESCAPE_CHAR = '"';

    private static final String LINE_END = "\n";

    private static final List<String> uitzonderingen =
            List.of(
                    "class",
                    "uuid",
                    "zaaktypeUuid",
                        ...
                        zoekObject -> {
                            try {
                                ...
                                final BeanInfo beanInfo =
                                        Introspector.getBeanInfo(zoekObject.getClass());
