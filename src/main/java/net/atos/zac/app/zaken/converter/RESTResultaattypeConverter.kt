...
public class RESTResultaattypeConverter {
    ...
    public RESTResultaattype convertResultaattype(final ResultaatType resultaattype) {
        ...
        restResultaattype.vervaldatumBesluitVerplicht = Afleidingswijze.VERVALDATUM_BESLUIT.toValue().equals(afleidingswijze.value());
        restResultaattype.besluitVerplicht = Afleidingswijze.VERVALDATUM_BESLUIT.toValue().equals(afleidingswijze.value()) ||
        ...
        restResultaattype.archiefTermijn = PeriodUtil.format(Period.parse(resultaattype.getArchiefactietermijn()));
