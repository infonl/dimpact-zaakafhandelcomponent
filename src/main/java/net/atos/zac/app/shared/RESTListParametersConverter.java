    ...
    public LP convert(final RLP restListParameters) {
        ...
        if (StringUtils.isNotBlank(restListParameters.sort)) {
            listParameters.setSorting(
                    new Sorting(
                            restListParameters.sort,
                            SorteerRichting.fromValue(restListParameters.order)));
        }
        listParameters.setPaging(
                new Paging(restListParameters.page, restListParameters.maxResults));
