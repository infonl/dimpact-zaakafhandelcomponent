...
public class AuditEnkelvoudigInformatieobjectConverter
  ...
  protected Stream<RESTHistorieRegel> doConvert(
    ...
    checkAttribuut(
        "ontvangstdatum", oud.getOntvangstdatum(), nieuw.getOntvangstdatum(), historieRegels);
    checkAttribuut(
        "registratiedatum",
    ...
    checkAttribuut(
        "bronorganisatie", oud.getBronorganisatie(), nieuw.getBronorganisatie(), historieRegels);
