...
public class RESTZaakafhandelParametersConverter {
  ...
  @Inject private RESTZaaktypeOverzichtConverter restZaaktypeOverzichtConverter;

  @Inject private RESTResultaattypeConverter resultaattypeConverter;

  @Inject private RESTZaakbeeindigParameterConverter zaakbeeindigParameterConverter;

  @Inject private RESTMailtemplateKoppelingConverter mailtemplateKoppelingConverter;

  @Inject private RESTUserEventListenerParametersConverter userEventListenerParametersConverter;

  @Inject private RESTHumanTaskParametersConverter humanTaskParametersConverter;
  ...
  public RESTZaakafhandelParameters convertZaakafhandelParameters(
      final ZaakafhandelParameters zaakafhandelParameters, final boolean inclusiefRelaties) {
    ...
    restZaakafhandelParameters.zaaktype =
        restZaaktypeOverzichtConverter.convert(
    ...
    if (inclusiefRelaties && restZaakafhandelParameters.caseDefinition != null) {
      ...
      restZaakafhandelParameters.userEventListenerParameters =
          userEventListenerParametersConverter.convertUserEventListenerParametersCollection(
      ...
      restZaakafhandelParameters.mailtemplateKoppelingen =
          mailtemplateKoppelingConverter.convert(
              zaakafhandelParameters.getMailtemplateKoppelingen());
      restZaakafhandelParameters.zaakAfzenders =
          zaakAfzenderConverter.convertZaakAfzenders(zaakafhandelParameters.getZaakAfzenders());
    }
    if (zaakafhandelParameters.getIntakeMail() != null) {
      restZaakafhandelParameters.intakeMail =
          RESTZaakStatusmailOptie.valueOf(zaakafhandelParameters.getIntakeMail());
    }
    if (zaakafhandelParameters.getAfrondenMail() != null) {
      restZaakafhandelParameters.afrondenMail =
          RESTZaakStatusmailOptie.valueOf(zaakafhandelParameters.getAfrondenMail());
    }
    restZaakafhandelParameters.productaanvraagtype =
        zaakafhandelParameters.getProductaanvraagtype();
  ...
  public ZaakafhandelParameters convertRESTZaakafhandelParameters(
    ...
    zaakafhandelParameters.setZaaktypeOmschrijving(
    ...
    zaakafhandelParameters.setGebruikersnaamMedewerker(
        restZaakafhandelParameters.defaultBehandelaarId);
    ...
    zaakafhandelParameters.setZaakAfzenders(
        zaakAfzenderConverter.convertRESTZaakAfzenders(restZaakafhandelParameters.zaakAfzenders));
