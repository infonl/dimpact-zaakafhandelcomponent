...
public enum FilterVeld {
  ...
  public static final Set<FilterVeld> TAAK_FACETTEN =
      Collections.unmodifiableSet(EnumSet.of(TAAK_NAAM, TAAK_STATUS, GROEP, BEHANDELAAR, ZAAKTYPE));
  ...
  public static FilterVeld fromValue(final String veld) {
    return Stream.of(FilterVeld.values())
        ...
        .findFirst()
        .orElseThrow(
            () -> new IllegalArgumentException(String.format("Onbekend Filterveld '%s'", veld)));
  }
