...
public enum MailTemplateVariabelen {
    ...
    public static final Set<MailTemplateVariabelen> DOCUMENT_SIGNALERING_VARIABELEN =
            add(
                    add(ZAAK_SIGNALERING_VARIABELEN, DOCUMENT_VARIABELEN),
                    DOCUMENT_BEHANDELAAR_VARIABELEN);

    private static Set<MailTemplateVariabelen> toSet(final MailTemplateVariabelen... values) {
        return Collections.unmodifiableSet(toEnumSet(Arrays.asList(values)));
    }

    private static Set<MailTemplateVariabelen> add(
            final Set<MailTemplateVariabelen> set, final Set<MailTemplateVariabelen> values) {
