...
public class HealthCheckService {
      ...
      try {
        buildDatumTijd =
            convertToLocalDateTime(
                ZonedDateTime.parse(readAllLines(buildDatumTijdFile.toPath()).get(0)));
  ...
  private void controleerZaaktypeResultaattypeInrichting(
    ...
    final List<ResultaatType> resultaattypes =
        ztcClientService.readResultaattypen(zaaktypeInrichtingscheck.getZaaktype().getUrl());
  ...
  private void controleerZaaktypeBesluittypeInrichting(
    ...
    final List<BesluitType> besluittypes =
        ztcClientService.readBesluittypen(zaaktypeInrichtingscheck.getZaaktype().getUrl()).stream()
  ...
  private void controleerZaaktypeInformatieobjecttypeInrichting(
    ...
    final List<InformatieObjectType> informatieobjecttypes =
        ztcClientService.readInformatieobjecttypen(zaaktypeInrichtingscheck.getZaaktype().getUrl());
