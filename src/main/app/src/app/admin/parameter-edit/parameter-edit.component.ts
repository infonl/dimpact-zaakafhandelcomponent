  ...
  implements OnInit, OnDestroy
{
  ...
  private getHumanTaskFormGroup(
    ...
    return this.formBuilder.group({
      startformulierDefinitie: [
        humanTaskParameters.startformulierDefinitieId,
        humanTaskParameters.actief ? [Validators.required] : [],
      ],
      afhandelformulierDefinitie: [
        humanTaskParameters.afhandelformulierDefinitieId,
        humanTaskParameters.actief ? [Validators.required] : [],
      ],
  ...
  actiefChanged(formGroupID: string) {
    ...
    if (actief) {
      formGroup
        .get("startformulierDefinitie")
        .setValidators([Validators.required]);
      formGroup
        .get("afhandelformulierDefinitie")
        .setValidators([Validators.required]);
    } else {
  ...
  opslaan(): void {
    ...
    this.humanTaskParameters.forEach((param) => {
      param.startformulierDefinitieId = this.getHumanTaskControl(
        param,
        "startformulierDefinitie",
      ).value;
      param.afhandelformulierDefinitieId = this.getHumanTaskControl(
        param,
        "afhandelformulierDefinitie",
      ).value;
