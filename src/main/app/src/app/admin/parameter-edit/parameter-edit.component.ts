  ...
  implements OnInit, OnDestroy, AfterViewInit
{
  ...
  protected filterOutMedewerkerMail(replyTos: GeneratedType<"RESTReplyTo">[]): GeneratedType<"RESTReplyTo">[] {
    return replyTos.filter((replyTo: GeneratedType<"RESTReplyTo">) => !(replyTo.speciaal && replyTo.mail === "MEDEWERKER"));
  }
