...
import {
    FileInputFormFieldBuilder
} from "src/app/shared/material-form-builder/form-components/file-input/file-input-form-field-builder";
...
export class InformatieObjectAddComponent implements AfterViewInit, OnDestroy {
    ...
    private getInputs(deps: { loggedInUser: GeneratedType<"RestLoggedInUser"> }) {
        ...
        const informatieobjectType = new SelectFormFieldBuilder()
            ...
            .options(
                this.informatieObjectenService.listInformatieobjecttypesForZaak(this.getZaakUuid()
                ))
