...
{
  public readonly temporaryPersonId?: string | null = null;
  ...
  constructor(
    ...
    switch (this.type) {
      case "BSN":
        ...
        if (
          "temporaryPersonId" in betrokkene &&
          betrokkene.temporaryPersonId !== null
        ) {
          this.temporaryPersonId = betrokkene.temporaryPersonId;
          break;
        }
        throw new Error(
