...
/**
 * Class used to indicate that the [GeoJSONGeometry] of a class should be deleted.
 ...
 * It is used by the [nl.info.client.zgw.zrc.jsonb.GeoJSONGeometryToBeDeletedJsonbSerializer].
 */
@AllOpen
@NoArgConstructor
class GeoJSONGeometryToBeDeleted : GeoJSONGeometry()
