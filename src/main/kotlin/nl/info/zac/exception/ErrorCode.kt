...
enum class ErrorCode(val value: String) {
    ...
    ERROR_CODE_CASE_TYPE_UUID_REQUIRED("msg.error.case.type.uuid.required"),
    ERROR_CODE_CASE_TYPE_DESCRIPTION_REQUIRED("msg.error.case.type.description.required"),
}
