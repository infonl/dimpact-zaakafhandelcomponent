INSERT
    ...
    VALUES(
        nextval('${schema}.sq_mail_template'),
        'Zaak ontvankelijk',
        'Wij hebben uw verzoek in behandeling genomen (zaaknummer: {zaaknummer})',
...
INSERT
    ...
    VALUES(
        ...
        '<p>Wij hebben uw verzoek niet in behandeling genomen (zaaknummer: {ZAAKNUMMER})</p>',
...
INSERT
    ...
    VALUES(
        nextval('${schema}.sq_mail_template'),
        'Zaak afgehandeld',
        '<p>Wij hebben uw verzoek afgehandeld (zaaknummer: {ZAAKNUMMER})</p>',
...
INSERT
    ...
    VALUES(
        nextval('${schema}.sq_mail_template'),
        'Proces aanvullende informatie',
        '<p>Aanvullende informatie nodig voor zaak {ZAAKNUMMER}</p>',
...
INSERT
    ...
    VALUES(
        nextval('${schema}.sq_mail_template'),
        'Proces advies',
        '<p>Advies nodig voor zaak {ZAAKNUMMER}</p>',
...
INSERT
    ...
    VALUES(
        nextval('${schema}.sq_mail_template'),
        'Proces ontvangsbevestiging',
        '<p>Ontvangstbevestiging van zaak {ZAAKNUMMER}</p>',
...
INSERT
    ...
    VALUES(
        nextval('${schema}.sq_mail_template'),
        'Signalering zaak document toegevoegd',
        '<p>Nieuw document aan zaak ‘{OMSCHRIJVINGZAAK}’ toegevoegd</p>',
...
INSERT
    ...
    VALUES(
        nextval('${schema}.sq_mail_template'),
        'Signalering zaak op naam',
        '<p>Nieuwe zaak op jouw naam met omschrijving: {OMSCHRIJVINGZAAK}</p>',
...
INSERT
    ...
    VALUES(
        nextval('${schema}.sq_mail_template'),
        'Signalering zaak verlopend streefdatum',
        '<p>We willen graag dat zaak {ZAAKNUMMER} op {STREEFDATUM} is afgehandeld</p>',
...
INSERT
    ...
    VALUES(
        nextval('${schema}.sq_mail_template'),
        'Signalering zaak verlopend fatale datum',
        '<p>Graag actie, op {FATALEDATUM} moet zaak {ZAAKNUMMER} afgehandeld zijn</p>',
...
INSERT
    ...
    VALUES(
        nextval('${schema}.sq_mail_template'),
        'Signalering taak op naam',
        '<p>Nieuwe taak op jouw naam voor een {ZAAKTYPE}-zaak</p>',
        '<p>Hoi!</p><p>Er is een taak voor een {ZAAKTYPE}-zaak op jouw naam gezet.</p><p>Klik om naar de taak te gaan {TAAKURL}</p>',
        'SIGNALERING_TAAK_OP_NAAM'
    );
...
INSERT
    ...
    VALUES(
        nextval('${schema}.sq_mail_template'),
        'Signalering taak verlopen',
        '<p>Actie nodig, handel jouw taak voor zaak {ZAAKNUMMER} spoedig af</p>',
