...
COMMENT ON COLUMN ${schema}.referentie_tabel.is_systeem_tabel IS 'Bepaalt of de referentietabel een systeemtabel is of niet. Systeemtabellen kunnen niet worden verwijderd door gebruikers.';
