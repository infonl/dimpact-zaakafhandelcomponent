...
The [`process definition`](./bpmn/E2ETestProcessDefinition.bpmn) can be found in the [`e2e/bpmn`](./bpmn) folder along with the required forms. These are needed for the process to be selectable for a case type.
