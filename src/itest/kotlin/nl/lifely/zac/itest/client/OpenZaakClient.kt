...
import nl.lifely.zac.itest.config.ItestConfiguration.OPENZAAK_CLIENT_ID
import nl.lifely.zac.itest.config.ItestConfiguration.OPENZAAK_CLIENT_SECRET
...
object OpenZaakClient {
    ...
    fun generateToken(): String =
        JWT.create().withIssuer(OPENZAAK_CLIENT_ID)
            .withIssuedAt(Date())
            .withHeader(mapOf("client_identifier" to OPENZAAK_CLIENT_ID))
            .withClaim("client_id", OPENZAAK_CLIENT_ID)
