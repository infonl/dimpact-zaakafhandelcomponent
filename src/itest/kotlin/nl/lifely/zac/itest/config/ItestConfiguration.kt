...
object ItestConfiguration {
    ...
    const val OBJECT_PRODUCTAANVRAAG_KVK_UUID = "85099eaf-821c-4046-8e82-fdc22c623fb8"
    const val OBJECT_PRODUCTAANVRAAG_KVK_NUMMER = "68750110"
    const val OBJECT_PRODUCTAANVRAAG_RSIN = "857587973"
