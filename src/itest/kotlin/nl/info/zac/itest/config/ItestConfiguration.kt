...
object ItestConfiguration {
    ...
    const val TEST_COORDINATOR_1_USERNAME = "recordmanager1"
    const val TEST_COORDINATOR_1_NAME = "Test Recordmanager1"
    const val TEST_BEHANDELAAR_1_USERNAME = "recordmanager1"
    const val TEST_BEHANDELAAR_1_NAME = "Test Recordmanager1"
    ...
    const val TEST_GROUP_COORDINATORS_ID = "test-group-rm"
    const val TEST_GROUP_COORDINATORS_DESCRIPTION = "Test group record managers"
    const val TEST_GROUP_BEHANDELAARS_ID = "test-group-rm"
    const val TEST_GROUP_BEHANDELAARS_DESCRIPTION = "Test group record managers"
