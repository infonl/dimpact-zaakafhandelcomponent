...
object ItestConfiguration {
    ...
    const val BETROKKENE_IDENTIFICATION_TYPE_VESTIGING = "VN"
    ...
    const val VERTROUWELIJKHEIDS_AANDUIDING_ZAAKVERTROUWELIJK = "ZAAKVERTROUWELIJK"
    const val VERTROUWELIJKHEIDS_AANDUIDING_OPENBAAR = "OPENBAAR"
    const val VERTROUWELIJKHEIDS_AANDUIDING_ZEER_GEHEIM = "ZEER_GEHEIM"
    ...
    @Suppress("MagicNumber")
    val DATE_2026_07_23: LocalDate = LocalDate.of(2026, Month.JULY, 23)
    ...
    const val ZAAKTYPE_CMMN_TEST_4_DOEL = "Testen afhandelwijze brondatum"
