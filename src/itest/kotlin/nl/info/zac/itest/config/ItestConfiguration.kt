...
object ItestConfiguration {
    ...
    const val BPMN_SUSPEND_RESUME_PROCESS_RESOURCE_PATH = "bpmn/suspend-resume/suspendResume.bpmn"
    const val BPMN_SUSPEND_RESUME_SUSPEND_FORM_RESOURCE_PATH = "bpmn/suspend-resume/suspendForm.json"
    const val BPMN_SUSPEND_RESUME_RESUME_FORM_RESOURCE_PATH = "bpmn/suspend-resume/resumeForm.json"
    const val BPMN_SUSPEND_RESUME_EXTEND_FORM_RESOURCE_PATH = "bpmn/suspend-resume/extendForm.json"
