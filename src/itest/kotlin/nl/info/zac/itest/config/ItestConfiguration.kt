...
object ItestConfiguration {
    ...
    const val OBJECT_PRODUCTAANVRAAG_6_UUID = "ce567a95-8b3b-4a14-8cba-122e450e1c57"
    ...
    const val OBJECT_PRODUCTAANVRAAG_6_BRON_KENMERK = "testKenmerkAlternativeEmailAddress3"
    ...
    const val TEST_PERSON_HENDRIKA_JANSE_PLACE_OF_RESIDENCE =
        "Street\u00A0#\u00A038\u00A0&\u00A0House\u00A0#\u00A010,\u00A0Baghdad," +
            "\u00A0Park\u00A0Al-Sadoum,\u00A0Hay\u00A0Al-Nidhal\u00A0103,\u00A0Irak"
    ...
    const val ZAAK_PRODUCTAANVRAAG_6_IDENTIFICATION = "ZAAK-1976-0000000001"
    const val ZAAK_PRODUCTAANVRAAG_6_OMSCHRIJVING = "fakeZaakOmschrijving-alternative-email-3"
    const val ZAAK_PRODUCTAANVRAAG_6_TOELICHTING = "fakeZaakToelichting-alternative-email-3"
    const val ZAAK_PRODUCTAANVRAAG_6_ALTERNATIVE_EMAIL = "test-alternative-3@example.com"
    const val ZAAK_PRODUCTAANVRAAG_6_ALTERNATIVE_TELEPHONE_NUMBER = "06-11118888"
