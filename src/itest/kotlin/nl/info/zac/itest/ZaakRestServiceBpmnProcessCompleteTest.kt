...
/**
 * This test creates a zaak and tasks for a zaaktype for which a BPMN process has been defined.
 * Bbecause we do not want this test to impact e.g. [SearchRestServiceTest] we run it afterward.
 */
@Order(TEST_SPEC_ORDER_AFTER_SEARCH)
class ZaakRestServiceBpmnProcessCompleteTest : BehaviorSpec({
    val itestHttpClient = ItestHttpClient()
    val zacClient = ZacClient()
    val logger = KotlinLogging.logger {}

    Given("A zaaktype for which a BPMN process definition has been defined") {
