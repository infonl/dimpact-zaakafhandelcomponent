...
import nl.info.zac.itest.config.ZAAKSPECIFIEKE_AUTORISATIE_BEHANDELAAR_1
                ...
                then("All available users in the Keycloak ZAC realm are returned") {
                    ...
                    response.bodyAsString shouldEqualSpecifiedJsonIgnoringOrder """
                            [                               
                                ...
                                {
                                    "id": "${ZAAKSPECIFIEKE_AUTORISATIE_BEHANDELAAR_1.username}",
                                    "naam": "${ZAAKSPECIFIEKE_AUTORISATIE_BEHANDELAAR_1.displayName}"
                                }
                            ]
                    """.trimIndent()
                }
