...
- [ ] 9.5 Manually smoke-test the "create zaak" flow in the running app (`./start-docker-compose.sh` or dev server) to confirm navigation to the new zaak's detail page still works end-to-end.
