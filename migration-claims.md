...
- [x] `dashboard/zaak-waarschuwingen-card/zaak-waarschuwingen-card.component.ts`
- [x] `dashboard/zaak-zoeken-card/zaak-zoeken-card.component.ts`
- [x] `dashboard/zaken-card/zaken-card.component.ts`
