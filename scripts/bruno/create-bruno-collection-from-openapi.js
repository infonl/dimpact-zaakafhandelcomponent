 ...
 *
 * Usage:
 *   node create-bruno-collection-from-openapi.js <collection-path> <openapi-url>
 *   node create-bruno-collection-from-openapi.js ./my-collection https://api.example.com/openapi.json
 */
 ...
 */
function createBrunoCollectionFromOpenapi(parentFolder, openApiSpec, options = {}) {
...
`);
    ...
    try {
        ...
        const result = createBrunoCollectionFromOpenapi(parentFolder, openApiSpec, options);
