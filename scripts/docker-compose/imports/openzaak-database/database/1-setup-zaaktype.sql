...
INSERT INTO catalogi_statustype (id, uuid, statustype_omschrijving, statustype_omschrijving_generiek, statustypevolgnummer, informeren, statustekst, toelichting, zaaktype_id, _etag) VALUES (3, uuid_generate_v4(), 'Heropend', 'Zaak heropend', 3, true, 'Geachte heer/mevrouw, Uw zaak is in heropend', 'Zaak is heropend', 2, '_etag');
...
INSERT INTO catalogi_eigenschap(id, toelichting, uuid, eigenschapnaam, definitie, specificatie_van_eigenschap_id, zaaktype_id, _etag) VALUES (22, '', uuid_generate_v4(), 'e-mailadres', 'e-mailadres', 1, 2, '_etag');
...
INSERT INTO catalogi_informatieobjecttype(id, datum_begin_geldigheid, datum_einde_geldigheid, concept, uuid, omschrijving, vertrouwelijkheidaanduiding, catalogus_id, _etag) VALUES (3, '2021-10-04', NULL, false, 'efc332f2-be3b-4bad-9e3c-49a6219c92a3', 'e-mail', 'zaakvertrouwelijk', 2, '_etag');
INSERT INTO catalogi_informatieobjecttype(id, datum_begin_geldigheid, datum_einde_geldigheid, concept, uuid, omschrijving, vertrouwelijkheidaanduiding, catalogus_id, _etag) VALUES (4, '2021-10-04', NULL, false, 'bf3fcf61-2a1d-4f88-b6fc-6c58ac75f294', 'bijlage', 'zaakvertrouwelijk', 2, '_etag');
