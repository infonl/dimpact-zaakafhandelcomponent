...
VALUES
    (
        ...
        'Verleend',
        'https://selectielijst.openzaak.nl/api/v1/resultaattypeomschrijvingen/f252f7ac-1b3c-4abb-b5a0-82d30605d421',
        'Verleend',
        'https://selectielijst.openzaak.nl/api/v1/resultaten/2d76e12c-69fd-4d00-966d-cad3fe3bc354',
        'vernietigen',
        'P1Y',
        'afgehandeld',
        '',
...
VALUES
    (
        ...
        'Geweigerd',
        'https://selectielijst.openzaak.nl/api/v1/resultaattypeomschrijvingen/7cc7f7af-5f64-4332-9f68-62a44286f5ec',
        'Geweigerd',
        'https://selectielijst.openzaak.nl/api/v1/resultaten/675e46e7-7a3d-46f4-ab90-7587b8de1f6d',
        'vernietigen',
        'P5Y',
        'afgehandeld',
        '',
...
VALUES
    (
        ...
        'Afgebroken',
        'https://selectielijst.openzaak.nl/api/v1/resultaattypeomschrijvingen/5b68365a-4b09-4dec-9e89-41bff38b893b',
        'Afgebroken',
        'https://selectielijst.openzaak.nl/api/v1/resultaten/76b0dc2f-a712-454b-8998-1bd7138529df',
        'vernietigen',
        'P1Y',
        'afgehandeld',
        '',
