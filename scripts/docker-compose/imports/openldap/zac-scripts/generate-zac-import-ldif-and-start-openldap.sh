...
sed "s/\${TESTUSER1_EMAIL_ADDRESS}/${ZAC_TESTUSER1_EMAIL_ADDRESS}/g;
...
s/\${TESTUSER_DOMEIN_TEST_1_EMAIL_ADDRESS}/${ZAC_TESTUSER_DOMEIN_TEST_1_EMAIL_ADDRESS}/g;
...
s/\${GROUP_DOMEIN_TEST_1_EMAIL_ADDRESS}/${ZAC_GROUP_DOMEIN_TEST_1_EMAIL_ADDRESS}/g;" /zac-scripts/zac-ldap-setup-template.ldif > /tmp/zac-ldap-setup.ldif
