...
sed "s/\${TESTUSER1_EMAIL_ADDRESS}/${ZAC_LDAP_TESTUSER1_EMAIL_ADDRESS}/g; s/\${TESTUSER2_EMAIL_ADDRESS}/${ZAC_LDAP_TESTUSER2_EMAIL_ADDRESS}/g; s/\${GROUP_A_EMAIL_ADDRESS}/${ZAC_LDAP_GROUP_A_EMAIL_ADDRESS}/g; s/\${GROUP_FUNCTIONEEL_BEHEERDERS_EMAIL_ADDRESS}/${ZAC_LDAP_GROUP_FUNCTIONEEL_BEHEERDERS_EMAIL_ADDRESS}/g;" /zac-scripts/zac-ldap-setup-template.ldif > /ldifs/zac-ldap-setup.ldif
