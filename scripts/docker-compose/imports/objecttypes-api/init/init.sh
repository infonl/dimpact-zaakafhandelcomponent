...
# Wait here a bit for the Objecttypes API database to be initialized (by Objecttypes).
# In the end better to add a health check to the Objecttypes API service in Docker Compose but
