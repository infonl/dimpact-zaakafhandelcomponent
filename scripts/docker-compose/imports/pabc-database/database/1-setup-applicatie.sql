...
INSERT INTO "DomainEntityType" ("DomainId", "EntityTypesId") VALUES
    ...
    ((SELECT "Id" FROM "Domains" WHERE "Name" = 'domein_test_1'), (SELECT "Id" FROM "EntityTypes" WHERE "Name" = 'Test zaaktype 2')),
    ((SELECT "Id" FROM "Domains" WHERE "Name" = 'domein_test_1'), (SELECT "Id" FROM "EntityTypes" WHERE "Name" = 'Test zaaktype 3'));
