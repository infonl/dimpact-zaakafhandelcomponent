...
| wijzigen                                                                         |                            X (status: zaak open)                            |             |       X       |           | OPA policy `zaak wijzigen`                                                  |
...
| verlengen                                                                        |            X (status: zaak open, niet heropend, niet opgeschort)            |             |               |           | Logica in ZakenRESTService.java. Afgeleid van OPA policy `zaak behandelen`. |
| opschorten                                                                       |            X (status: zaak open, niet heropend, niet opgeschort)            |             |               |           | Logica in ZakenRESTService.java. Afgeleid van OPA policy `zaak behandelen`. |
| hervatten                                                                        |                                      X                                      |             |               |           | Logica in ZakenRESTService.java. Afgeleid van OPA policy `zaak behandelen`. |
| creeeren_document                                                                |                            X (status: zaak open)                            |             |       X       |           | OPA policy `zaak wijzigen`                                                  |
| toevoegen_document                                                               |                            X (status: zaak open)                            |             |       X       |           | OPA policy `zaak wijzigen`                                                  |
...
| vastleggen_besluit                                                               |     X (status: zaak open, niet in intake, zaaktype heeft besluittypen)      |             |               |           | Logica in ZakenRESTService.java. Afgeleid van OPA policy `zaak behandelen`. |
| verlengen_doorlooptijd                                                           |            X (status: zaak open, niet heropend, niet opgeschort)            |             |               |           | Logica in ZakenRESTService.java. Afgeleid van OPA policy `zaak behandelen`. |
|                                                                                  |                                                                             |             |               |           |                                                                             |
| **_Taak rechten_**                                                               |                                                                             |             |               |           |                                                                             |
...
| wijzigen                                                                         | X (status: zaak open, document onvergrendeld of vergrendeld door gebruiker) |             |       X       |           | OPA policy `document wijzigen`                                              |
| verwijderen                                                                      |                                      X                                      |             |       X       |           | OPA policy `document verwijderen`                                           |
| vergrendelen                                                                     |                            X (status: zaak open)                            |             |       X       |           | OPA policy `document vergrendelen`                                          |
| ontgrendelen                                                                     |                   X (document vergrendeld door gebruiker)                   |             |       X       |           | OPA policy `document ontgrendelen`                                          |
| ondertekenen                                                                     | X (status: zaak open, document onvergrendeld of vergrendeld door gebruiker) |             |               |           | OPA policy `document ondertekenen`                                          |
...
| zaken_taken                                                                      |                                      X                                      |      X      |       X       |           | OPA policy `werklijst zaken_taken`                                          |
