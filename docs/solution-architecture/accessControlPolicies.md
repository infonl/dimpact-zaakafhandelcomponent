...
| wijzigen                                      | X (zaak open, document onvergrendeld, niet definitief of vergrendeld door gebruiker) |             |       X       |               | OPA policy `document wijzigen`                                   |
| verwijderen                                   |                      X (Document onvergrendeld door gebruiker)                       |             |       X       |               | OPA policy `document verwijderen`                                |
