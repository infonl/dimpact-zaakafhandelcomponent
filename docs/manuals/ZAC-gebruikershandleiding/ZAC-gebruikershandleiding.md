...
**_Zaakafhandelcomponent (ZAC) gebruikershandleiding_**
...
| Status | :   | Definitief |
| Redacteur | :   | Karin Masselink |
| Auteur(s) | :   | Roy Buis, Camiel Braun |
|     |     |     |
...
Vanuit de werklijst kunnen de documenten met de klembord functionaliteit verplaatst worden naar een zaak. Dit kan door vanuit het overzicht op het schaar icoon te klikken.
...
Vanuit de werklijst kunnen de documenten met de klembord functionaliteit verplaatst worden naar een zaak. Dit kan door vanuit het overzicht op het schaar icoon te klikken. Met het prullenbak icoon kunnen de documenten verwijderd worden.
...
Als de Zaken-werkvoorraad of Taken-werkvoorraad geopend is dan kan de verdelen functie geactiveerd worden door een of meerdere van de items te selecteren. Met de Verdelen knop kan aangegeven worden aan welke groep en/of behandelaar de gekozen items toegekend moeten worden.  
...
3\. Klik op de Verdelen onderaan het scherm
...
Met de Vrijgeven knop kan een item van de behandelaar afgehaald worden. Deze functie, die bijvoorbeeld handig is als iemand uit dienst of op vakantie gaat, werkt op een soortgelijke manier als de Verdelen functie en kan ook alleen door de Coördinator gedaan worden.  
...
De zoekfunctie is vanuit de werkbalk te openen en kan direct gebruikt worden door het invoeren van zoektermen. Het zoekpanel kan ook geopend worden door op het vergrootglas icoon te klikken en daarna in het scherm de zoektermen in te geven.

In het zoekpanel kan gekozen worden voor vier categorieën: zaken, personen, bedrijven en BAG-objecten. Iedere categorie heeft haar eigen zoekscherm dat benaderd kan worden door op respectievelijk het dossier, poppetje, gebouw of kompas icoon te klikken.
