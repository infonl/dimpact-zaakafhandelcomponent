...
# -----------------------------------------
DOCKER_COMPOSE_TEST_USER_1_EMAIL_ADDRESS=op://Dimpact/ZAC-.env-$APP_ENV/DOCKER_COMPOSE/LDAP_TEST_USER_1_EMAIL_ADDRESS
DOCKER_COMPOSE_TEST_USER_2_EMAIL_ADDRESS=op://Dimpact/ZAC-.env-$APP_ENV/DOCKER_COMPOSE/LDAP_TEST_USER_2_EMAIL_ADDRESS
DOCKER_COMPOSE_RECORD_MANAGER_1_EMAIL_ADDRESS=op://Dimpact/ZAC-.env-$APP_ENV/DOCKER_COMPOSE/LDAP_RECORD_MANAGER_1_EMAIL_ADDRESS
DOCKER_COMPOSE_FUNCTIONAL_ADMIN_1_EMAIL_ADDRESS=op://Dimpact/ZAC-.env-$APP_ENV/DOCKER_COMPOSE/LDAP_FUNCTIONAL_ADMIN_1_EMAIL_ADDRESS
DOCKER_COMPOSE_TESTUSER_DOMEIN_TEST_1_EMAIL_ADDRESS=op://Dimpact/ZAC-.env-$APP_ENV/DOCKER_COMPOSE/LDAP_TESTUSER_DOMEIN_TEST_1_EMAIL_ADDRESS
DOCKER_COMPOSE_GROUP_A_EMAIL_ADDRESS=op://Dimpact/ZAC-.env-$APP_ENV/DOCKER_COMPOSE/LDAP_GROUP_A_EMAIL_ADDRESS
DOCKER_COMPOSE_GROUP_FUNCTIONEEL_BEHEERDERS_EMAIL_ADDRESS=op://Dimpact/ZAC-.env-$APP_ENV/DOCKER_COMPOSE/LDAP_GROUP_FUNCTIONEEL_BEHEERDERS_EMAIL_ADDRESS
DOCKER_COMPOSE_GROUP_RECORD_MANAGERS_EMAIL_ADDRESS=op://Dimpact/ZAC-.env-$APP_ENV/DOCKER_COMPOSE/LDAP_GROUP_RECORD_MANAGERS_EMAIL_ADDRESS
DOCKER_COMPOSE_GROUP_DOMEIN_TEST_1_EMAIL_ADDRESS=op://Dimpact/ZAC-.env-$APP_ENV/DOCKER_COMPOSE/LDAP_GROUP_DOMEIN_TEST_1_EMAIL_ADDRESS
